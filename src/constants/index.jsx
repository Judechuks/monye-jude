...
export const skills = [
  {
    id: 1,
    title: "HTML",
    iconUrl: icons.htmlIcon,
    bgColor: "bg-[#FC490B]",
  },
  {
    id: 2,
    title: "CSS",
    iconUrl: icons.cssIcon,
    bgColor: "bg-[#2A7EBD]",
  },
  {
    id: 3,
    title: "Bootstrap",
    iconUrl: icons.bootstrapIcon,
    bgColor: "bg-[#8311FA]",
  },
  {
    id: 4,
    title: "TailwindCSS",
    iconUrl: icons.tailwindIcon,
    bgColor: "bg-[#16BECB]",
  },
  {
    id: 5,
    title: "Sass",
    iconUrl: icons.sassIcon,
    bgColor: "bg-[#CD6799]",
  },
  {
    id: 6,
    title: "Javascript",
    iconUrl: icons.javascriptIcon,
    bgColor: "bg-[#F7E018]",
  },
  {
    id: 7,
    title: "Reactjs",
    iconUrl: icons.reactIcon,
    bgColor: "bg-[#00bcd4]",
  },
  {
    id: 8,
