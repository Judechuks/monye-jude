      ...
      <article className="flex gap-3 mb-12 flex-wrap">
        {skills.map((item, index) => (
          <button
            ...
            } py-2 px-3 mt-4 border rounded-md uppercase text-sm cursor-pointer focus:ring-offset-1 focus:ring-2 focus:ring-blue-700 hover:bg-blue-800 hover:text-white duration-500`}
          >
            {item}
          </button>
        ))}
