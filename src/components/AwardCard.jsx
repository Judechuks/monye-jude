...
const AwardCard = ({
  ...
  return (
    <article className="card w-full mb-12 md:w-[70%] md:mx-auto flex flex-col justify-between group overflow-hidden relative rounded-lg border-2 p-5 transition duration-500 cursor-pointer hover:shadow-navbar">
      <header>
        <h4 className="font-bold text-md mb-3">{title}</h4>
        <div className="relative grid gap-1 text-slate-gray dark:text-white-400">
      ...
      <footer>
        <p className="font-semibold text-slate-gray dark:text-white-400">
          Presented By: {by}
        </p>
      </footer>
