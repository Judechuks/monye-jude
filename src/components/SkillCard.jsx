...
const SkillCard = ({ skill, imageurl, bgcolor }) => {
  return (
    <div
      className={`bg-[#13aa52] skills group relative z-30 cursor-pointer h-12 overflow-hidden transition-all duration-700`}
    >
      ...
      <div
        className={`bg-[#13aa52] z-10 -top-1 rounded-full group-hover:w-full group-hover:opacity-30 absolute w-0 h-12 transition-all duration-500 opacity-100`}
      ></div>
    </div>
  );
};
